	...
	static final boolean method1899(int i, byte b, String string) {
		...
		if (Class240.aSignLink2946.aBoolean4005) {
			...
			if (Node_Sub38_Sub1.aClass329_10086 != Class240.aClass329_2943) {
				Class181.aClass197_2155.firstPort = Loader.PORT_ID;//40000 + Class181.aClass197_2155.id;
		...
		String string_6_ = "http://" + string.replace("runescape", "Zenith") + string_4_ + "/l=" + Class35.language + "/a=" + Class170.anInt2056 + string_5_ + "/j" + (Animable_Sub2_Sub1.aBoolean10628 ? "1" : "0") + ",o" + (Node_Sub38_Sub21.aBoolean10320 ? "1" : "0") + ",a2";
		try {
