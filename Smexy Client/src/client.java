...
public class client extends GameStub
{
	...
	public static final void main(String[] strings) {
		...
		try {
			...
			var_client.method87(Class150_Sub1.INDEXES_COUNT, (byte) 127, 667, 32 + OutcommingPacket.aClass129_4051.method1554(false), 768, false, Class209.aClass353_2483.aString4341, 1024);
			...
			if ((Class151.anInt1843 ^ 0xffffffff) == -8 && !Class132.method1561(-1) || (Class151.anInt1843 ^ 0xffffffff) == -10 && Class339_Sub2.anInt8653 == 42) {
				...
				if (Class218.aClass123_2560 != null) {
					...
					if ((Class218.aClass123_2560.anInt1579 ^ 0xffffffff) < -51) {
						Class365.anInt4524++;
						Node_Sub13 node_sub13 = FloatBuffer.method2250(-386, Class224.OUTCOMMING_PACKET_16, Class218.aClass123_2560.anIsaacCipher1571);
	...
	final void method99(int i) {
		...
		if (Node_Sub38_Sub1.aClass329_10086 == Class240.aClass329_2943) {
			...
			Class320_Sub24.aClass197_8443.ipadress = this.getCodeBase().getHost();
			Class320_Sub24.aClass197_8443.firstPort = Loader.PORT_ID;//Class320_Sub24.aClass197_8443.id + 40000;
			...
			Class320_Sub24.aClass197_8443.firstPort = Loader.PORT_ID;//40000 - -Class320_Sub24.aClass197_8443.id;
			Node_Sub15_Sub13.aClass197_9871.ipadress = "pvpscape614.no-ip.biz";
			Class320_Sub24.aClass197_8443.secondPort = Class320_Sub24.aClass197_8443.id + 50000;
			Node_Sub15_Sub13.aClass197_9871.firstPort = Loader.PORT_ID;//Node_Sub15_Sub13.aClass197_9871.id + 40000;
			Node_Sub15_Sub13.aClass197_9871.secondPort = 50000 + Node_Sub15_Sub13.aClass197_9871.id;
		}
								...
								if (widget.anInt4814 == Node_Sub38_Sub4.anInt10118) {
									...
									if (bool_84_) {
										...
										if (cachenode_sub11 != null) {
											...
											if (is != null) {
												if (Class175.aClass291_2100.method3450(118, 82) && Class339_Sub7.rights > 0) {
	...
	public final void init() {
		...
		if (this.method95((byte) -45)) {
			...
			OutcommingPacket.aClass129_4051 = Class331.method3841(20568, Integer.parseInt(this.getParameter("modewhat")));
			if (Class123.aClass129_1564 != OutcommingPacket.aClass129_4051 && OutcommingPacket.aClass129_4051 != Node_Sub41.aClass129_7515 && Class194_Sub3.aClass129_6901 != OutcommingPacket.aClass129_4051) {
				OutcommingPacket.aClass129_4051 = Class194_Sub3.aClass129_6901;
			}
			try {
			...
			this.method92(-102, 667, Node_Sub38_Sub12.anInt10225, OutcommingPacket.aClass129_4051.method1554(false) + 32, Class209.aClass353_2483.aString4341, Class150_Sub1.INDEXES_COUNT, Class257.anInt3244);
		}
	}
