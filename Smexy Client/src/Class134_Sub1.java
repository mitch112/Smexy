	...
	static final void method1580(int i, int i_2_, CacheNode_Sub13 cachenode_sub13, int i_3_) {
		...
		if (cachenode_sub13 != null && cachenode_sub13 != Class368.aClass312_4549.aNode3958) {
			...
			if ((i_6_ ^ 0xffffffff) == -45) {
				Player player = Class270_Sub2.LOCAL_PLAYERS[i_7_];
				if (player != null) {	
					...
					node_sub13.aPacket7113.writeShortLE(i_7_);
			...
			if (i_6_ == 12) {
				...
				if (i_6_ == 58) {
					if ((Class339_Sub7.rights ^ 0xffffffff) >= -1 || !Class175.aClass291_2100.method3450(119, 82) || !Class175.aClass291_2100.method3450(i_2_ ^ 0x6a, 81)) {
						int steps = Class275.calculateRoute(Class295.myPlayer.scenePositionXQueue[0], Class295.myPlayer.scenePositionYQueue[0], i_4_, i_5_, Class295.myPlayer.getSize((byte) 0), -4, true, 1, 1, 0, 0, Class304.SCENE_CLIP_DATA_PLANES[Class295.myPlayer.plane], Class328_Sub1.calculatedScenePositionXs, Class258.calculatedScenePositionYs, (byte) -41);
						Node_Sub13 node_sub13 = Class22.createWalkPacket(steps, i_7_);
						if (i_7_ == 1) {
						...
						Class331.method3843(false, Class295.myPlayer.plane, Class320_Sub4.gameSceneBaseY - -i_5_, Node_Sub53.gameSceneBaseX + i_4_);
					}
				}
				...
				if (class318 != null) {
					...
					if (player != null) {
						...
						node_sub13.aPacket7113.writeShort(i_7_);
				...
				if (class318_8_ != null) {
					...
					if(class318_8_ != Class51_Sub1.aClass318_9061) { //droped item examine
						int steps = Class275.calculateRoute(Class295.myPlayer.scenePositionXQueue[0], Class295.myPlayer.scenePositionYQueue[0], i_4_, i_5_, Class295.myPlayer.getSize((byte) 0), -1, true, 1, 1, 0, 0, Class304.SCENE_CLIP_DATA_PLANES[Class295.myPlayer.plane], Class328_Sub1.calculatedScenePositionXs, Class258.calculatedScenePositionYs, (byte) -41);
						Node_Sub13 packet = Class22.createWalkPacket(steps, 0);
						Class218.aClass123_2566.sendPacket(126, packet);
					}
					Class163.anInt2014 = i;
					...
					node_sub13.aPacket7113.writeShort128(i_7_);
					node_sub13.aPacket7113.writeByte(!Class175.aClass291_2100.method3450(94, 82) ? 0 : 1);
					node_sub13.aPacket7113.writeShort(i_5_ + Class320_Sub4.gameSceneBaseY);
				...
				if (i_6_ == 11) {
					if ((Class339_Sub7.rights ^ 0xffffffff) < -1 && Class175.aClass291_2100.method3450(-121, 82) && Class175.aClass291_2100.method3450(111, 81)) {
						...
						node_sub13.aPacket7113.writeShortLE128(i_5_ + Class320_Sub4.gameSceneBaseY);
						node_sub13.aPacket7113.writeShortLE(Node_Sub53.gameSceneBaseX + i_4_);
						Class218.aClass123_2566.sendPacket(126, node_sub13);
					}
				}
				...
				OutcommingPacket class318_9_ = null;
				if (i_6_ != 49) {
					if (i_6_ != 59) {
				...
				if (class318_9_ != null) {
					...
					if (node_sub41 != null) {
						...
						if(class318_9_ != Class66_Sub2_Sub1.aClass318_10581) {//examine 
						...
						Class163.anInt2014 = i;
						Node_Sub37.anInt7431 = 0;
						Node_Sub13 node_sub13 = FloatBuffer.method2250(i_2_ ^ ~0x180, class318_9_, Class218.aClass123_2566.anIsaacCipher1571);
				...
				if (class318_10_ != null) {
					if(class318_10_ != Animable_Sub2.aClass318_9114) {//examine 
						...
						if (routeType != 10 && routeType != 11 && (routeType ^ 0xffffffff) != -23) {
							steps = Class275.calculateRoute(Class295.myPlayer.scenePositionXQueue[0], Class295.myPlayer.scenePositionYQueue[0], i_4_, i_5_, Class295.myPlayer.getSize((byte) 0), routeType, true, 0, 0, 0, rotation, Class304.SCENE_CLIP_DATA_PLANES[Class295.myPlayer.plane], Class328_Sub1.calculatedScenePositionXs, Class258.calculatedScenePositionYs, (byte) -41);	
						} else {
							...
							steps = Class275.calculateRoute(Class295.myPlayer.scenePositionXQueue[0], Class295.myPlayer.scenePositionYQueue[0], i_4_, i_5_, Class295.myPlayer.getSize((byte) 0), 0, true, sizeX, sizeY, i_8_, 0, Class304.SCENE_CLIP_DATA_PLANES[Class295.myPlayer.plane], Class328_Sub1.calculatedScenePositionXs, Class258.calculatedScenePositionYs, (byte) -41);
						}
						Node_Sub13 packet = Class22.createWalkPacket(steps, 0);
						Class218.aClass123_2566.sendPacket(126, packet);
					}
					...
					node_sub13.aPacket7113.writeShortLE(i_5_ - -Class320_Sub4.gameSceneBaseY);
					Class218.aClass123_2566.sendPacket(i_2_ + 125, node_sub13);
				...
				if ((i_6_ ^ 0xffffffff) == -22) {
					...
					node_sub13.aPacket7113.writeShort128(Class320_Sub4.gameSceneBaseY + i_5_);
				...
				if ((i_6_ ^ 0xffffffff) == -18) {
					...
					node_sub13.aPacket7113.writeShort(Class320_Sub4.gameSceneBaseY + i_5_);
				...
				if (i_6_ == 60) {
					...
					node_sub13.aPacket7113.writeShortLE(Class320_Sub4.gameSceneBaseY + i_5_);
					node_sub13.aPacket7113.writeShortLE(Class46.anInt681);
					node_sub13.aPacket7113.writeIntLE(Node_Sub15_Sub9.anInt9839);
					node_sub13.aPacket7113.writeShortLE128(Class92.anInt1230);
