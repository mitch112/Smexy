...
public class Class126
{
	...
	static final void method1538(int i, boolean bool, boolean bool_11_, String string) {
		...
		try {
			...
			if(string.equalsIgnoreCase("screenshotpath")) {
			...
			if (string.equalsIgnoreCase("getcamerapos2")) {
				...
				int x = ((Class98.anInt5061 >> 9) + Node_Sub53.gameSceneBaseX >> 6) * 64 + ((Class98.anInt5061 >> 9) - -Node_Sub53.gameSceneBaseX & 0x3f);
				int y = ((Node_Sub10.anInt7079 >> 9) + Class320_Sub4.gameSceneBaseY >> 6) * 64 + ((Node_Sub10.anInt7079 >> 9) - -Class320_Sub4.gameSceneBaseY & 0x3f);
				Node_Sub7.method2422((byte) 43, "Pos: plane:" + plane + ", x:" + x + ", y: "+y+", Height: " + (Node_Sub38_Sub7.method2809(Class295.myPlayer.plane, -29754, Node_Sub10.anInt7079, Class98.anInt5061) + -Class190.anInt2331));
				int x2 = ((Class238.anInt2911 >> 9) + Node_Sub53.gameSceneBaseX >> 6) * 64 + ((Class238.anInt2911 >> 9) - -Node_Sub53.gameSceneBaseX & 0x3f);
				int y2 = ((Class10.anInt174 >> 9) + Class320_Sub4.gameSceneBaseY >> 6) * 64 + ((Class10.anInt174 >> 9) - -Class320_Sub4.gameSceneBaseY & 0x3f);
				Node_Sub7.method2422((byte) 43, "Look: plane:" + plane + ", x:" + x2 + ", y: "+y2+", Height: " + (Node_Sub38_Sub7.method2809(Class295.myPlayer.plane, -29754, Class10.anInt174, Class238.anInt2911) + -Class134_Sub1.anInt9015));
				//	Node_Sub7.method2422((byte) 43, "Look: " + Class295.myPlayer.plane + "," + (Class238.anInt2911 + Node_Sub53.gameSceneBaseX >> 6) + "," + (Class320_Sub4.gameSceneBaseY + Class10.anInt174 >> 6) + "," + (0x3f & Node_Sub53.gameSceneBaseX + Class238.anInt2911) + "," + (0x3f & Class320_Sub4.gameSceneBaseY + Class10.anInt174) + " Height: " + (Node_Sub38_Sub7.method2809(Class295.myPlayer.plane, -29754, Class10.anInt174, Class238.anInt2911) + -Class134_Sub1.anInt9015));
				return;
			}
		...
		if (Class339_Sub7.rights >= 2) {
			...
			try {
				...
				if (string.equalsIgnoreCase("getcgcoord")) {
					Node_Sub7.method2422((byte) 43, "x:" + (Class295.myPlayer.anInt5934 >> 9) + " z:" + (Class295.myPlayer.anInt5940 >> 9));
					return;
				}
				if (string.equalsIgnoreCase("getheight")) {
					Node_Sub7.method2422((byte) 43, "Height: " + Class320_Sub10.aPlaneArray8300[Class295.myPlayer.plane].method3251(Class295.myPlayer.anInt5940 >> 9, Class295.myPlayer.anInt5934 >> 9, (byte) -118));
					return;
				}
				...
				if ((Class151.anInt1843 ^ 0xffffffff) == -12) {
					...
					Node_Sub13 node_sub13 = FloatBuffer.method2250(-386, Class247.aClass318_3130, Class218.aClass123_2566.anIsaacCipher1571);
