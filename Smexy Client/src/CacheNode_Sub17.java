...
public class CacheNode_Sub17 extends CacheNode implements Interface2
{
	...
	static final String method2394(byte b) {
		...
		return "http://" + string.replace("runescape", "Zenith") + "." + Class209.aClass353_2483.aString4341 + ".com/l=" + Class35.language + "/a=" + Class170.anInt2056 + string_4_ + "/";
	}
	...
	static final BufferedStream method2397(byte b) {
		anInt8844++;
		...
		//buffer.rsaDecrypt(0, Class203.aBigInteger2451, Class262_Sub10.aBigInteger7775);
		return buffer;
	}
