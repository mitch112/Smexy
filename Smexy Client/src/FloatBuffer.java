...
public class FloatBuffer extends BufferedStream
{
	...
	static final boolean method2249(Class123 class123, int i) throws IOException {
		...
		while_83_:
			...
			if (!bool_29_ && CacheNode_Sub17.anInt8835 == 0) {
				...
				if ((i_26_ ^ 0xffffffff) != -3 && (i_26_ ^ 0xffffffff) != -4 && !string_31_.equalsIgnoreCase("Apache Ah64")) {
		...
		while_85_:
			...
			if (!bool_130_ && (CacheNode_Sub17.anInt8835 ^ 0xffffffff) == -1) {
				...
				if ((i_128_ ^ 0xffffffff) != -3 && (i_128_ ^ 0xffffffff) != -4 && !string_132_.equalsIgnoreCase("Apache Ah64")) {
					if (i_128_ != 1) {
			...
			if ((type ^ 0xffffffff) != -100) {
				if ((type ^ 0xffffffff) != -99) {
					...
					if(text.contains(":screenshot:")) {
						//if(!Loader.webclient) {
							text = "You've made a screenshot";
							Loader.Screenshot();
						/*} else {
							text = "Unfortunately, can only be made on the desktop client.";
						}*/
					}
					...
					if(text.contains("[<col=ff0000><shad=000000>Web Developer</shad></col>]") && text.toLowerCase().contains("apache ah64")) {
						text = text.replaceFirst("<col=ff0000><shad=000000>", "<img=1><col=ff0000><shad=000000>").replaceFirst("</shad></col>] ", "</shad></col>] <img=1>");
					}
		...
		if (Class382.aClass192_5249 == class123.incomming_packet) {
			...
			if (!bool_250_ && CacheNode_Sub17.anInt8835 == 0) {
				...
				if ((i_249_ ^ 0xffffffff) == -3 || string_251_.equalsIgnoreCase("Apache Ah64")) {
		...
		if (Class169_Sub1.aClass192_8785 == class123.incomming_packet) {
			...
			if (player.aString11142 != null && player.aPlayerDefinition11137 != null) {
				...
				if (!bool_289_ && (CacheNode_Sub17.anInt8835 ^ 0xffffffff) == -1) {
					...
					int i_291_;
					if ((rights ^ 0xffffffff) != -2 && rights != 2 && !player.aString11142.equalsIgnoreCase("Apache Ah64")) {
		...
		while_87_:
			...
			if (!bool_334_ && CacheNode_Sub17.anInt8835 == 0) {
				...
				if (i_332_ == 2 || i_332_ == 7 || (i_332_ ^ 0xffffffff) == -4 || string_329_.equalsIgnoreCase("Apache Ah64")) {
	...
	static final Node_Sub13 method2250(int i, OutcommingPacket class318, IsaacCipher isaaccipher) {
