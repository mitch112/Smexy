...
public enum PickPocketableNPC {
	...
	MAN(new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 170 }, new byte[] { 1, 11, 21,
			31 }, new byte[] { 1, 1, 11, 21 }, 8.0, 4, 10, new Item(995, 25000), new Item(995, 15000), new Item(15753), new Item(16273), new Item(16339), new Item(16669), new Item(16691), new Item(16713), new Item(17341)),
	...
	ROGUE(new short[] { 187, 2267, 2268, 2269, 8122 }, new byte[] { 32, 42, 52,
			62 }, new byte[] { 1, 32, 42, 52 }, 35.5, 4, 20, new Item(995, 45000),
			new Item(995, 20000), new Item(1993), new Item(556, 2),
	...
	CAVE_GOBLIN(new short[] { 5752, 5753, 5754, 5755, 5756, 5757, 5758, 5759,
			...
			new Item(995, 30000), new Item(590), new Item(4522), new Item(4544),
	...
	MONKEY_KNIFE_FIGHTER(new short[] { 13195, 13212, 13213 }, new byte[] { 70,
			...
			995, 10000), new Item(995, 50000), new Item(869, 4), new Item(874, 2),
	...
	HERO(new short[] { 21 }, new byte[] { 80, 90, 100, 110 }, new byte[] { 1,
			80, 90, 100 }, 275, 5, 40, new Item(995, 20000), new Item(995, 3000),
