...
public class Magic {
	...
	public static final void processNormalSpell(Player player, int spellId,
		...
		case 69: // troll
			sendNormalTeleportSpell(player, 0, 0,
					new WorldTile(2888, 3674, 0));
			break;
		case 72: // ape
			sendNormalTeleportSpell(player, 0, 0,
					new WorldTile(2804, 2786, 0));
			break;
		}
	}
